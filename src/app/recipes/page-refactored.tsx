...
import { useRecipesGeneration } from "@/hooks/useRecipesGeneration";
import { useRecipesNavigation } from "@/hooks/useRecipesNavigation";
...
export default function RecipesPage() {
  ...
  const {
    ...
    generateRecipes,
    clearCache,
  } = useRecipesGeneration();

  const { activeIndex, scrollToRecipe } = useRecipesNavigation(recipes.length);
