...
export const cacheRecipes = (
  ...
  setCacheItem(cacheKey, recipes, ttlSeconds);
};
...
export const cacheImage = (
  ...
  setCacheItem(cacheKey, imageUrl, ttlSeconds);
};
...
export const getCachedImage = (
  ...
  const cacheKey = getImageCacheKey(recipeName, ingredients);
  return getCacheItem<string>(cacheKey);
};
...
export const clearRecipesCache = (): void => {
  if (typeof window === "undefined") return;
