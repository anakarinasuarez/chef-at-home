...
export const getDesignToken = (
  ...
  switch (category) {
    ...
    case 'typography':
      return typography.styles[token as keyof typeof typography.styles] || typography.styles['body-medium'];
    
    case 'spacing':
      return spacingSystem.base[token as keyof typeof spacingSystem.base] || spacingSystem.base[4];
    
    case 'breakpoints':
      return breakpointSystem.breakpoints[token as keyof typeof breakpointSystem.breakpoints] || breakpointSystem.breakpoints.md;
